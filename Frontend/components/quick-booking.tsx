...
// //             Skip the hassle. Select your preferred time slot and book instantly
// //             with our lightning-fast booking system.
// //           </p>
// //         </div>
...
//   const getNextAvailableSlots = () => timeSlots.filter((slot) => slot.available).slice(0, 6);

//   const calculateTotal = () => {
//     const slot = timeSlots.find((s) => s.time === selectedTime);
//     return slot ? slot.price * selectedDuration : 0;
//   };
...
//           <Badge className="bg-green-100 text-green-800 text-sm px-4 py-2 font-medium mb-4">
//             ⚡ Quick Booking
//           </Badge>
...
//             Select a slot and confirm your booking instantly.
//           </p>
//         </div>
...
//                         <div className="text-xs">{d === 1 ? "hour" : "hours"}</div>
//                       </button>
//                     ))}
//                   </div>
//                 </div>
...
//                   onClick={handleQuickBook}
//                   disabled={isLoading || !selectedTime}
//                   className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-4 text-base font-semibold shadow hover:shadow-lg transition"
//                 >
//                   {isLoading ? (
...
//                 </div>
//                 {selectedTime && (
//                   <div className="bg-green-50 p-2 rounded text-green-700 flex items-center gap-2 mt-2">
//                     <CheckCircle className="h-4 w-4" />
//                     Slot Available
//                   </div>
//                 )}
...
//                 <h3 className="font-semibold text-gray-800 mb-3">Why Quick Book?</h3>
//                 <div className="space-y-2">
//                   {[Zap, CreditCard, Clock, CheckCircle].map((Icon, i) => (
//                     <div key={i} className="flex items-center gap-3">
//                       <div className="p-2 bg-white rounded-full">
//                         <Icon className="h-4 w-4 text-green-600" />
//                       </div>
//                       <span className="text-sm text-gray-700">
//                         {["Instant confirmation", "Secure payment", "Save time", "Best price guarantee"][i]}
//                       </span>
//                     </div>
//                   ))}
//                 </div>
...
//             <Card className="shadow-lg bg-white text-center">
//               <CardContent className="p-4">
