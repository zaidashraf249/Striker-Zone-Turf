...
import { ChevronLeft, ChevronRight, Play, Share2, Heart, Eye } from "lucide-react"

const galleryItems = [
  {
    id: 1,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Striker+Zone+Main+Turf+Evening",
    title: "Main Football Turf - Evening View",
    description: "Premium artificial grass with professional floodlighting for night games",
    category: "Football",
    likes: 89,
    views: 2400,
  ...
  },
  {
    id: 2,
    type: "video",
    src: "/placeholder.svg?height=600&width=800&text=Match+Action+Reel",
  ...
  },
  {
    id: 3,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Professional+Floodlights",
  ...
  },
  {
    id: 4,
    type: "video",
    src: "/placeholder.svg?height=600&width=800&text=Skills+Training+Reel",
  ...
  },
  {
    id: 5,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Team+Celebration",
  ...
  },
  {
    id: 6,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Turf+Maintenance",
  ...
  },
  {
    id: 7,
    type: "video",
    src: "/placeholder.svg?height=600&width=800&text=Facility+Walkthrough",
  ...
  },
  {
    id: 8,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Players+Changing+Room",
  ...
  },
  {
    id: 9,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Spectator+Area",
  ...
  },
  {
    id: 10,
    type: "video",
    src: "/placeholder.svg?height=600&width=800&text=Goal+Compilation",
  ...
  },
  {
    id: 11,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Corporate+Tournament",
  ...
  },
  {
    id: 12,
    type: "image",
    src: "/placeholder.svg?height=600&width=800&text=Youth+Training",
...
const categories = ["All", "Football", "Cricket", "Facilities", "Lighting", "Videos"]
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Gallery</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore our world-class facilities through high-quality photos and videos. See why Striker Zone is the
            preferred choice for serious players.
          </p>
        </div>
        ...
        <div className="text-center mb-8">
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-6">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900">Follow @strikers.zone_</h3>
                <p className="text-gray-600 text-sm">See more photos and videos on Instagram</p>
              </div>
            </div>
            <a
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-3xl p-8 lg:p-12">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Ready to Experience It Yourself?</h3>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Pictures speak louder than words, but playing here speaks the loudest. Book your slot and experience our
              premium facilities firsthand.
            </p>
