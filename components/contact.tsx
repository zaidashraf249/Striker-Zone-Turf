...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: "", email: "", phone: "", message: "", eventType: "general" })
  }
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about booking, facilities, or special events? We're here to help you plan the perfect game
            experience.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800">
                ...
                hours. For urgent bookings, please call us directly.
              </p>
            </div>
          </div>
        </div>
